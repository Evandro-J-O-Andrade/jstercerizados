...
export const SEO_PAGES = {
    '/': {
        ...
        description: 'Assessoria em RH, recrutamento, mão de obra temporária e efetiva, terceirização e facilities. Mais eficiência para sua empresa.',
        keywords: [
            'assessoria em RH',
            'recrutamento',
            'seleção de pessoas',
    ...
    '/vagas': {
        ...
        description: 'Confira centenas de vagas de emprego atualizadas diariamente. Encontre a oportunidade certa para seu perfil e candidate-se agora.',
        keywords: [
            'vagas de emprego',
            'empregos',
            'trabalho',
    ...
    '/empresas': {
        ...
        description: 'Encontramos os profissionais certos para sua empresa. Mão de obra temporária e efetiva, recrutamento seletivo e assessoria completa em RH.',
        keywords: [
    ...
    '/candidatos': {
        ...
        description: 'Cadastre seu currículo e encontre as oportunidades compatíveis com seu perfil.',
    ...
    '/servicos': {
        ...
        description: 'Soluções completas em RH: Recrutamento, seleção, mão de obra temporária e efetiva, assessoria em RH e facilities. Tudo para sua empresa.',
        keywords: [
            'serviços de RH',
            'recrutamento',
            'mão de obra temporária',
    ...
    '/processo-seletivo': {
        ...
        description: 'Entenda as etapas do nosso processo seletivo: cadastro, candidatura, avaliação e contratação.',
    ...
    '/clientes': {
        ...
        description: 'Veja as empresas que já confiam na nossa agência e depoimentos de clientes satisfeitos.',
        keywords: ['clientes', 'depoimentos', 'empresas parceiras'],
        path: '/clientes',
    },
    '/contato': {
        title: `Fale Conosco | Contato | ${COMPANY.name}`,
        description: 'Entre em contato com a nossa equipe. WhatsApp, e-mail e telefone para dúvidas sobre vagas, recrutamento e serviços.',
        keywords: ['contato', 'fale conosco', 'whatsapp', 'atendimento', 'suporte'],
        path: '/contato',
    },
    '/suporte': {
        title: `Suporte e Atendimento | ${COMPANY.name}`,
        description: 'Tire suas dúvidas sobre nossos serviços, processos e oportunidades. Atendimento rápido via WhatsApp.',
        keywords: ['suporte', 'atendimento', 'dúvidas', 'ajuda', 'whatsapp'],
        path: '/suporte',
    },
    '/faq': {
        title: `Perguntas Frequentes | FAQ | ${COMPANY.name}`,
        description: 'Tire suas dúvidas sobre nossos serviços, processos de recrutamento e oportunidades de emprego.',
        keywords: [
    ...
    '/login': {
        ...
        description: 'Acesse sua conta de candidato, empresa ou RH para acompanhar processos e vagas.',
        keywords: [
            'login',
            'entrar',
            'acessar conta',
    ...
    '/blog': {
        ...
        description: 'Artigos sobre recrutamento, carreira, dicas de emprego e tendências do RH.',
