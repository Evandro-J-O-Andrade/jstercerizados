export const IMAGES = {
  ...
  services: {
    seguranca: '/images/servicos/controle-acesso.jfif',
    acesso: '/images/servicos/controle-acesso.jfif',
    ...
    recepcao: '/images/servicos/recepcao.svg',
    facilities: '/images/servicos/facilities-real.webp',
    monitoramento: '/images/servicos/monitoramento.svg',
