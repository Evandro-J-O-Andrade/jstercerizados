...
import { ExperienceDialog } from '@/features/candidato/components/candidate/ExperienceDialog';
import { EducationDialog } from '@/features/candidato/components/candidate/EducationDialog';
import { CourseDialog } from '@/features/candidato/components/candidate/CourseDialog';
import { LanguageDialog } from '@/features/candidato/components/candidate/LanguageDialog';
import { SkillDialog } from '@/features/candidato/components/candidate/SkillDialog';
import { DocumentDialog } from '@/features/candidato/components/candidate/DocumentDialog';
import { PreferencesDialog } from '@/features/candidato/components/candidate/PreferencesDialog';
                  ...
                  <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                      ...
                      preferences.desired_roles.length > 0 && (
                        <div>
                          ...
                          <p className="text-foreground">
                            {preferences.desired_roles.join(', ')}
                          </p>
                        </div>
                      )}
                    {preferences.desired_locations &&
                      preferences.desired_locations.length > 0 && (
                        <div>
                          <span className="text-muted-foreground text-xs">
                            Localizações:
                          </span>
                          <p className="text-foreground">
                            {preferences.desired_locations.join(', ')}
                          </p>
                        </div>
                      )}
                    {(preferences.salary_min || preferences.salary_max) && (
                      <div>
                        ...
                        <p className="text-foreground">
                          {preferences.salary_min?.toLocaleString('pt-BR', {
                            style: 'currency',
                            currency: 'BRL',
                          }) || '—'}
                          {' - '}
                          {preferences.salary_max?.toLocaleString('pt-BR', {
                            style: 'currency',
                            currency: 'BRL',
                          }) || '—'}
                        </p>
                    ...
                    {preferences.contract_types &&
                      preferences.contract_types.length > 0 && (
                        <div>
                          ...
                          <p className="text-foreground">
                            {preferences.contract_types.join(', ')}
                          </p>
                        </div>
                      )}
