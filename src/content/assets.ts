export const SERVICE_IMAGES = {
  ...
  maoDeObraTemporaria: '/images/servicos/mao-de-obra-temporaria/Mão de Obra Temporaria.jpg',
  maoDeObraEfetiva: '/images/servicos/mao-de-obra-efetiva/Mão de Obra Efetiva.jpg',
  ...
  maoDeObraEfetivaReal:
    '/images/servicos/mao-de-obra-efetiva/Mão de Obra Efetiva.jpg',
  bancoTalentoRealJpg:
    '/images/servicos/banco-talento.jfif',
...
export const SHOWCASE_SLIDES = [
  ...
  {
    src: SERVICE_IMAGES.facilitiesReal,
    alt: 'Facilities e Terceirização',
    objectPosition: 'center',
  },
  {
    src: SERVICE_IMAGES.maoDeObraTemporariaReal,
    alt: 'Mão de Obra Temporária e Efetiva',
    objectPosition: 'center',
  },
  {
    src: SERVICE_IMAGES.limpezaReal,
    alt: 'Limpeza e Conservação',
    objectPosition: 'center 25%',
  },
  {
    src: SERVICE_IMAGES.jardinagemReal,
    alt: 'Jardinagem e Paisagismo',
    objectPosition: 'center',
  },
  {
    src: SERVICE_IMAGES.terceirizacaoReal,
