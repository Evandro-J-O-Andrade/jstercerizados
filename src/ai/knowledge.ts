export const JS_AI_KNOWLEDGE = {
  ...
  candidates: {
    routes: ['/vagas', '/candidatos', '/trabalhe-conosco', '/processo-seletivo'],
    guidance: [
  ...
  faq: {
    route: '/faq',
    guidance: 'Para perguntas frequentes, consultar /faq quando a resposta não estiver no contexto fornecido.',
  },
} as const;
