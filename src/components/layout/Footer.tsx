...
const TikTokIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M2 12v7a3 3 0 0 0 3 3h16a1 1 0 0 0 1-1v-7" />
    <path d="M11 5a5 5 0 0 1 0 10H6a5 5 0 0 1 0-10h5z" />
    <path d="M17.59 3.5a6.5 6.5 0 0 1 0 13.18" />
  </svg>
);
      ...
      <div className="w-full">
        ...
        <div className="mt-8 w-full">
          ...
          <div className="border-border/50 bg-primary/5 rounded-xl border p-8">
            ...
            <Link
              to="/login"
              className="border-border hover:border-primary/30 group flex items-center gap-3 rounded-xl border p-4 transition-all duration-300"
            >
              <div className="bg-primary/10 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg">
                <LogIn className="text-primary h-5 w-5 transition-transform group-hover:translate-x-1" />
              </div>
              <div className="min-w-0 flex-1">
