  ...
  return (
    <footer className="border-border/50 bg-surface relative z-10 border-t">
      ...
      <div className="w-full">
        <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 lg:max-w-[1920px] lg:px-8 xl:max-w-[2200px] xl:px-10">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="text-muted-foreground flex items-center gap-2 text-xs">
              ...
              <span>
                © {new Date().getFullYear()} {COMPANY.tradingName}. Todos os
                direitos reservados.
              </span>
            </div>
          </div>
