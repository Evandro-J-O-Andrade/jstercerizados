...
export function PartnerSupplierCard({
  ...
  return (
    <motion.article
      ...
      whileHover={{ y: -4 }}
    >
      <Card variant="interactive" hover className="flex h-full flex-col">
        <div className="bg-surface-alt relative flex h-44 items-center justify-center overflow-hidden rounded-t-xl">
          {heroMedia ? (
            <SafeImage
              src={heroMedia}
              alt={name}
