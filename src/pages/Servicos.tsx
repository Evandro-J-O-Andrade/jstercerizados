...
export default function Servicos() {
  ...
  const visibleServices = source === 'db' ? dbServices : mockServices;

  const rhServices = visibleServices.filter((s) => s.category === 'rh');
  const facilitiesServices = visibleServices.filter(
          ...
          {error && !isLoading ? (
            ...
            <>
              ...
              >
                ...
                >
                  Soluções completas em Recursos Humanos e Facilities para
                  apoiar o crescimento da sua empresa.
                </motion.p>
              </motion.div>
