          ...
          >
            {[
              ...
              <motion.div
                ...
                className="card-base card-hover group relative overflow-hidden rounded-2xl p-6 transition-all duration-300"
              >
      ...
      <Section>
        <Container>
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="card-base rounded-3xl p-8 text-center sm:p-12"
          >
