...
import { FileCheck, Shield, UserCheck } from 'lucide-react';
...
export default function LgpdPage() {
  ...
  useEffect(() => {
    ...
    const fetchAcceptances = async () => {
      try {
        ...
        console.error('[LGPD] Failed to load:', error);
      } finally {
        setLoading(false);
      }
    };
  ...
  const lgpdCount = acceptances.filter(
    (a) => a.document_type === 'lgpd',
  ).length;
